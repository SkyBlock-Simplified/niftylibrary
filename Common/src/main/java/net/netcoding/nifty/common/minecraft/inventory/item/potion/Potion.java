...
public final class Potion { // TODO
	...
	public boolean equals(Object obj) {
		if (this == obj)
			...
			return false;
		else if (!Potion.class.isAssignableFrom(obj.getClass()))
			return false;
		else {
	...
	public void setTier(Tier tier) {
		Preconditions.checkArgument(tier != null, "Tier cannot be null!");
	...
	public static void setPotionBrewer(PotionBrewer other) {
		Preconditions.checkArgument(brewer != null, "Brewer can only be set internally!");
