...
public class ChannelWrapper {
	...
	protected abstract class Nifty extends ChannelWrapper {
		...
		protected Nifty() {
			super(net.netcoding.nifty.common.Nifty.getPlugin(), BungeeHelper.NIFTY_CHANNEL, null);

			if (net.netcoding.nifty.common.Nifty.getBungeeHelper() != null)
		...
		public void handle(String channel, byte[] message) {
			net.netcoding.nifty.common.Nifty.getBungeeHelper().handleNifty(channel, message);
		}
