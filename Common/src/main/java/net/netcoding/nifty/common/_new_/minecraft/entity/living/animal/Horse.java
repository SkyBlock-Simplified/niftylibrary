...
import net.netcoding.nifty.common._new_.minecraft.entity.vehicle.Vehicle;
import net.netcoding.nifty.common._new_.minecraft.inventory.InventoryHolder;
import net.netcoding.nifty.common._new_.minecraft.inventory.types.HorseInventory;
