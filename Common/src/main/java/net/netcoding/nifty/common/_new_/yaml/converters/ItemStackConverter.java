...
public class ItemStackConverter extends Converter {
	...
	public Object fromConfig(Class<?> type, Object section, ParameterizedType genericType) throws Exception {
		...
		net.netcoding.nifty.common._new_.minecraft.inventory.item.ItemStack item = Nifty.getItemDatabase().get((String)itemMap.get("id"));
	...
	public Object toConfig(Class<?> type, Object obj, ParameterizedType genericType) throws Exception {
		net.netcoding.nifty.common._new_.minecraft.inventory.item.ItemStack item = (net.netcoding.nifty.common._new_.minecraft.inventory.item.ItemStack)obj;
	...
	public boolean supports(Class<?> type) {
		return net.netcoding.nifty.common._new_.minecraft.inventory.item.ItemStack.class.isAssignableFrom(type);
	}
