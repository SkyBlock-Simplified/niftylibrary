...
public enum Achievement {
	...
	BUILD_WORKBENCH(MINE_WOOD, "buildWorkbench"),
	...
	GET_DIAMONDS(ACQUIRE_IRON, "diamonds"),
	NETHER_PORTAL(GET_DIAMONDS, "portal"),
	GHAST_RETURN(NETHER_PORTAL, "ghast"),
	GET_BLAZE_ROD(NETHER_PORTAL, "blazeRod"),
	BREW_POTION(GET_BLAZE_ROD, "potion"),
	END_PORTAL(GET_BLAZE_ROD, "theEnd"),
	THE_END(END_PORTAL, "theEnd2"),
	...
	Achievement(Achievement parent, String name) {
		this.parent = parent;
		this.name = StringUtil.format("achievement.{0}", (StringUtil.notEmpty(name) ? name : CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.LOWER_CAMEL, this.name())));
	}

	/**
	 * Gets this achievements nms name.
	 *
	 * @return Achievement nms name.
	 */
