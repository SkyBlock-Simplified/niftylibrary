...
public final class BlockConverter extends Converter {
	...
	public Object fromConfig(Class<?> type, Object section, ParameterizedType genericType) throws Exception {
		...
		Converter locationConverter = this.getConverter(net.netcoding.nifty.common.minecraft.region.Location.class);
		Location location = (Location)locationConverter.fromConfig(Location.class, blockMap.get("location"), null);
		net.netcoding.nifty.common.minecraft.block.Block block = location.getBlock();
		net.netcoding.nifty.common.minecraft.inventory.item.ItemStack stack = Nifty.getItemDatabase().get((String)blockMap.get("id"));
	...
	public boolean supports(Class<?> type) {
		return net.netcoding.nifty.common.minecraft.block.Block.class.isAssignableFrom(type);
	}
