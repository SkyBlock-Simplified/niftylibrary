...
public abstract class ServerPingEvent implements ServerEvent {

	private static final int PROTOCOL = MinecraftProtocol.getCurrentProtocol();
	private final InetAddress internalAddress;
	private String motd;
	private int numPlayers;
	private int maxPlayers;

	protected ServerPingEvent(InetAddress internalAddress, String motd, int numPlayers, int maxPlayers) {
