...
import net.netcoding.nifty.common._new_.minecraft.entity.explosive.PrimedTNT;
import net.netcoding.nifty.common._new_.minecraft.entity.hanging.ItemFrame;
import net.netcoding.nifty.common._new_.minecraft.entity.hanging.LeashHitch;
import net.netcoding.nifty.common._new_.minecraft.entity.hanging.Painting;
import net.netcoding.nifty.common._new_.minecraft.entity.living.Ageable;
import net.netcoding.nifty.common._new_.minecraft.entity.living.ArmorStand;
import net.netcoding.nifty.common._new_.minecraft.entity.living.Bat;
...
import net.netcoding.nifty.common._new_.minecraft.entity.living.Villager;
import net.netcoding.nifty.common._new_.minecraft.entity.living.animal.*;
import net.netcoding.nifty.common._new_.minecraft.entity.living.complex.ComplexEntityPart;
import net.netcoding.nifty.common._new_.minecraft.entity.living.complex.EnderDragon;
import net.netcoding.nifty.common._new_.minecraft.entity.living.golem.IronGolem;
import net.netcoding.nifty.common._new_.minecraft.entity.living.golem.Shulker;
import net.netcoding.nifty.common._new_.minecraft.entity.living.golem.SnowGolem;
import net.netcoding.nifty.common._new_.minecraft.entity.living.monster.*;
import net.netcoding.nifty.common._new_.minecraft.entity.projectile.*;
import net.netcoding.nifty.common._new_.minecraft.entity.projectile.explosive.DragonFireball;
import net.netcoding.nifty.common._new_.minecraft.entity.projectile.explosive.LargeFireball;
import net.netcoding.nifty.common._new_.minecraft.entity.projectile.explosive.SmallFireball;
import net.netcoding.nifty.common._new_.minecraft.entity.projectile.explosive.WitherSkull;
import net.netcoding.nifty.common._new_.minecraft.entity.vehicle.Boat;
import net.netcoding.nifty.common._new_.minecraft.entity.vehicle.minecart.CommandMinecart;
import net.netcoding.nifty.common._new_.minecraft.entity.vehicle.minecart.ExplosiveMinecart;
import net.netcoding.nifty.common._new_.minecraft.entity.vehicle.minecart.HopperMinecart;
import net.netcoding.nifty.common._new_.minecraft.entity.vehicle.minecart.PoweredMinecart;
import net.netcoding.nifty.common._new_.minecraft.entity.vehicle.minecart.RideableMinecart;
import net.netcoding.nifty.common._new_.minecraft.entity.vehicle.minecart.SpawnerMinecart;
import net.netcoding.nifty.common._new_.minecraft.entity.vehicle.minecart.StorageMinecart;
import net.netcoding.nifty.common._new_.minecraft.entity.weather.LightningStrike;
import net.netcoding.nifty.common._new_.minecraft.entity.weather.Weather;
