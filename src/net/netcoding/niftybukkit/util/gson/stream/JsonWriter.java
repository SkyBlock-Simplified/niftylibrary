...
package net.netcoding.niftybukkit.util.gson.stream;

import static net.netcoding.niftybukkit.util.gson.stream.JsonScope.DANGLING_NAME;
import static net.netcoding.niftybukkit.util.gson.stream.JsonScope.EMPTY_ARRAY;
import static net.netcoding.niftybukkit.util.gson.stream.JsonScope.EMPTY_DOCUMENT;
import static net.netcoding.niftybukkit.util.gson.stream.JsonScope.EMPTY_OBJECT;
import static net.netcoding.niftybukkit.util.gson.stream.JsonScope.NONEMPTY_ARRAY;
import static net.netcoding.niftybukkit.util.gson.stream.JsonScope.NONEMPTY_DOCUMENT;
import static net.netcoding.niftybukkit.util.gson.stream.JsonScope.NONEMPTY_OBJECT;
