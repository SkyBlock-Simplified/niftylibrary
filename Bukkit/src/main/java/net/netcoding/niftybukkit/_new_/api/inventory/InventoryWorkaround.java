...
public class InventoryWorkaround {
	...
	private static int nextPartial(Inventory inventory, net.netcoding.niftybukkit._new_.minecraft.inventory.item.ItemStack item, int maxAmount, int slotNumber) {
		if (item == null) return -1;
		net.netcoding.niftybukkit._new_.minecraft.inventory.item.ItemStack[] stacks = inventory.getContents();
