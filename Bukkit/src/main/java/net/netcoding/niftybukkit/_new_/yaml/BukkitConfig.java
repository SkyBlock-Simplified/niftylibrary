...
import net.netcoding.niftybukkit._new_.yaml.converters.Block;
import net.netcoding.niftybukkit._new_.yaml.converters.ItemStack;
import net.netcoding.niftybukkit._new_.yaml.converters.Location;
import net.netcoding.niftybukkit._new_.yaml.converters.Vector;
