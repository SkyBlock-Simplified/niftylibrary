package net.netcoding.niftybukkit._new_.api.plugin;

import com.google.common.base.Preconditions;
import net.netcoding.niftybukkit._new_.api.Listener;
			...
			for (Map.Entry<Plugin, ConcurrentSet<Listener>> entry : listeners.entrySet()) {
				...
				for (Listener listener : entry.getValue()) {
					for (Method method : listener.getClass().getDeclaredMethods()) {
						...
						// Not An Event
						if (!method.isAnnotationPresent(net.netcoding.niftybukkit._new_.api.Event.class))
							continue;
						...
						// Details
						net.netcoding.niftybukkit._new_.api.Event eventAnno = method.getAnnotation(net.netcoding.niftybukkit._new_.api.Event.class);
						net.netcoding.niftybukkit._new_.api.Event.Priority priority = eventAnno.priority();
